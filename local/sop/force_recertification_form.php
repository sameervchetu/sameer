...
class force_recertification_action_form extends moodleform {
    function definition() {
        global $CFG;
        ...
        $objs = array();
        $objs[] =& $mform->createElement('submit', 'action', get_string('force_recertify', 'local_sop'));
        $mform->addElement('group', 'actionsgrp', get_string('withselectedusers'), $objs, ' ', false);
    }
}

class force_recertif_form extends moodleform {
    function definition() {
