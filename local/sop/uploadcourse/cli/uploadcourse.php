...
$modes = array(
    'createnew' => sop_tool_uploadcourse_processor::MODE_CREATE_NEW,
    'createall' => sop_tool_uploadcourse_processor::MODE_CREATE_ALL,
    'createorupdate' => sop_tool_uploadcourse_processor::MODE_CREATE_OR_UPDATE,
    'update' => sop_tool_uploadcourse_processor::MODE_UPDATE_ONLY
);
...
$updatemodes = array(
    'nothing' => sop_tool_uploadcourse_processor::UPDATE_NOTHING,
    'dataonly' => sop_tool_uploadcourse_processor::UPDATE_ALL_WITH_DATA_ONLY,
    'dataordefaults' => sop_tool_uploadcourse_processor::UPDATE_ALL_WITH_DATA_OR_DEFAUTLS,
    'missingonly' => sop_tool_uploadcourse_processor::UPDATE_MISSING_WITH_DATA_OR_DEFAUTLS
);
if (($processoroptions['mode'] === sop_tool_uploadcourse_processor::MODE_CREATE_OR_UPDATE ||
        $processoroptions['mode'] === sop_tool_uploadcourse_processor::MODE_UPDATE_ONLY)
