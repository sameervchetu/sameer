 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sop_tool_uploadcourse_step2_form extends tool_uploadcourse_base_form {
    ...
    public function definition () {
        ...
        $mform->disabledIf('options[shortnametemplate]', 'options[mode]', 'eq', sop_tool_uploadcourse_processor::MODE_CREATE_OR_UPDATE);
        $mform->disabledIf('options[shortnametemplate]', 'options[mode]', 'eq', sop_tool_uploadcourse_processor::MODE_UPDATE_ONLY);
        ...
        $mform->disabledIf('options[reset]', 'options[mode]', 'eq', sop_tool_uploadcourse_processor::MODE_CREATE_NEW);
        $mform->disabledIf('options[reset]', 'options[mode]', 'eq', sop_tool_uploadcourse_processor::MODE_CREATE_ALL);
