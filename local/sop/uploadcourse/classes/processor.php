...
require_once($CFG->dirroot . '/local/sop/uploadcourse/classes/helper.php');
require_once($CFG->dirroot . '/local/sop/uploadcourse/classes/course.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sop_tool_uploadcourse_processor {
    ...
    public function execute($tracker = null) {
        ...
        if (empty($tracker)) {
            $tracker = new sop_tool_uploadcourse_tracker(sop_tool_uploadcourse_tracker::NO_OUTPUT);
        }
        $tracker->start();
    ...
    protected function get_course($data) {
        ...
        return new sop_tool_uploadcourse_course($this->mode, $this->updatemode, $data, $this->defaults, $importoptions);
    }
    ...
    protected function get_restore_content_dir() {
        ...
        $dir = sop_tool_uploadcourse_helper::get_restore_content_dir($backupfile, $shortname);
        return $dir;
    }
